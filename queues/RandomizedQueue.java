 ...
 *  Name:
 *  Date:
 *  Description: Randomized queue. A randomized queue is similar to a stack or queue, except that the item removed is chosen uniformly at random from items in the data structure.
    ...
    public static void main(String[] args) {
        ...
        while (!StdIn.isEmpty()) {
            ...
            if (item.equals("-")) {
                ...
                if (!inTheQueue(de, shouldBeQueue)) throw new NullPointerException(
                        "sample item is wrong:" + de + "[line:" + step_count + "]");
            }
            else {
                q.enqueue(item);
                shouldBeSize++;
